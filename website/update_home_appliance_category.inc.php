...
?>
   ...
   <form name="category" action="index.php" method="post">
       ...
       <input type="text" name="categoryCode" id="categoryCode" value="<?php echo $category->HomeApplianceCategoryCode; ?>">
       <label for="categoryName">Category Name:</label>
       <input type="text" name="categoryName" id="categoryName" value="<?php echo $category->HomeApplianceCategoryName; ?>">
       <input type="submit" name="answer" value="Update Category">
       <input type="submit" name="answer" value="Cancel">
       <input type="hidden" name="categoryID" value="<?php echo $categoryID; ?>">
       <input type="hidden" name="content" value="change_home_appliance_category">
   </form>
<?php
} else {
?>
